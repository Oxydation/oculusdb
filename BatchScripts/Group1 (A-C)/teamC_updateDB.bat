...
C:\xampp\mysql\bin\mysql.exe --default-character-set=utf8 --user=root --database=oculus_c < .\oculusdb_wb.sql
C:\xampp\mysql\bin\mysql.exe --default-character-set=utf8 --debug-info --user=root --database=oculus_c < .\fillDB.sql
pause